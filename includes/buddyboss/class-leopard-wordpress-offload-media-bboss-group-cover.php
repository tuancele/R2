...
class Leopard_Wordpress_Offload_Media_BBoss_Group_Cover extends Leopard_Wordpress_Offload_Media_BBoss_Item {
	/**
	 * Source type name
	 *
	 * @var string
	...
	public static function admin_link( $error ) {
		return Leopard_Wordpress_Offload_Media_BBoss_Group_Avatar::admin_link( $error );
	}
}