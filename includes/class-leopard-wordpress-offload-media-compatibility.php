...
class Leopard_Wordpress_Offload_Media_Compatibility {
	...
	public function wp_calculate_image_srcset( $sources, $size_array, $image_src, $image_meta, $attachment_id ) {
		...
		foreach ( $sources as $width => $source ) {
			...
			if($enable_webp){
				$key = Leopard_Wordpress_Offload_Media_Utils::get_key_from_url($provider_url, false);
			...
			$provider_url = leopard_wordpress_offload_media_get_real_url($provider_url);
			$cloudfront_url = leopard_wordpress_offload_media_s3_to_cloudfront_url($provider_url);
