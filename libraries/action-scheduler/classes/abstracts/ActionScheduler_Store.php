...
abstract class ActionScheduler_Store extends ActionScheduler_Store_Deprecated {
	...
	protected function validate_action( ActionScheduler_Action $action ) {
		if ( strlen( json_encode( $action->get_args() ) ) > static::$max_args_length ) {
			throw new InvalidArgumentException( sprintf( __( 'ActionScheduler_Action::$args too long. To ensure the args column can be indexed, action args should not be more than %d characters when encoded as JSON.', 'leopard-wordpress-offload-media' ), static::$max_args_length ) );
		}
	}
	...
	public function get_status_labels() {
		return array(
			self::STATUS_COMPLETE => __( 'Complete', 'leopard-wordpress-offload-media' ),
			self::STATUS_PENDING  => __( 'Pending', 'leopard-wordpress-offload-media' ),
			self::STATUS_RUNNING  => __( 'In-progress', 'leopard-wordpress-offload-media' ),
			self::STATUS_FAILED   => __( 'Failed', 'leopard-wordpress-offload-media' ),
			self::STATUS_CANCELED => __( 'Canceled', 'leopard-wordpress-offload-media' ),
		);
	}
