...
class ActionScheduler_DBStore extends ActionScheduler_Store {
	...
	public function save_action( ActionScheduler_Action $action, \DateTime $date = null ) {
		try {
			...
			elseif ( empty( $action_id ) ) {
				throw new RuntimeException( $wpdb->last_error ? $wpdb->last_error : __( 'Database error.', 'leopard-wordpress-offload-media' ) );
			}
	...
	protected function get_query_actions_sql( array $query, $select_or_count = 'select' ) {
		...
		if ( ! in_array( $select_or_count, array( 'select', 'count' ) ) ) {
			throw new InvalidArgumentException( __( 'Invalid value for select or count parameter. Cannot query actions.', 'leopard-wordpress-offload-media' ) );
		}
	...
	public function get_status( $action_id ) {
		...
		if ( $status === null ) {
			...
			throw new \RuntimeException( __( 'Unknown status found for action.', 'leopard-wordpress-offload-media' ) );
		} else {
			return $status;
		}
	}
